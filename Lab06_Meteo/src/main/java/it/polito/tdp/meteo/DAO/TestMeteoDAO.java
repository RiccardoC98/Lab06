...
public class TestMeteoDAO {
	...
	System.out.println(dao.getAllRilevamentiLocalitaMese(9, "Genova"));
	System.out.println(dao.getAllRilevamentiLocalitaMese(12, "Genova").size());  // controllavo se fossero 31 valori per il mese di Gennaio --> OK
